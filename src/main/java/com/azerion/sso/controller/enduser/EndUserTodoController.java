package com.azerion.sso.controller.enduser;

import com.azerion.sso.controller.TodoController;
import com.azerion.sso.controller.resource.TodoResource;
import com.azerion.sso.controller.resource.assembler.TodoEndUserResourceAssembler;
...
@RestController
@RequestMapping("api/v1/end-user/todo")
@Slf4j
public class EndUserTodoController implements TodoController {
